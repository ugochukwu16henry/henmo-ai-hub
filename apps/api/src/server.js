  ...
  res.json({
    ...
    endpoints: {
      ...
      ai: {
        ...
        personalities: 'GET /api/ai/personalities',
...
app.post(
  ...
  PaymentController.processContributorPayout
);
app.delete(
  '/api/payment/subscription',
  AuthMiddleware.authenticate,
...
app.get(
  '/api/analytics/conversation-trends',
  AuthMiddleware.authenticate,
...
app.post(
  '/api/ai/memory',
  AuthMiddleware.authenticate,
  AIController.storeMemory
);
app.get(
  '/api/ai/memory/search',
  AuthMiddleware.authenticate,
  AIController.searchMemories
);
app.post(
  '/api/ai/summarize',
  AuthMiddleware.authenticate,
...
app.post(
  '/api/ai/chat-lang',
  AuthMiddleware.authenticate,
  AIController.chatInLanguage
);
app.get('/api/ai/languages', AIController.getSupportedLanguages);
app.post(
  '/api/ai/personality',
  AuthMiddleware.authenticate,
  AIController.chatWithPersonality
);
app.get('/api/ai/personalities', AIController.getPersonalities);
app.post(
  '/api/ai/personality/custom',
  AuthMiddleware.authenticate,
  AIController.createCustomPersonality
);
app.get(
  '/api/ai/costs',
  AuthMiddleware.authenticate,
  AIController.getUserCosts
);
app.get(
  '/api/ai/limits',
  AuthMiddleware.authenticate,
  AIController.checkUserLimits
);
app.get(
  '/api/ai/cost-report',
  AuthMiddleware.authenticate,
  AIController.generateCostReport
);
app.post(
...
try {
  ...
  // Email scheduler is optional - only initialize if node-cron is available
  try {
    EmailScheduler.init();
    console.log('Email scheduler initialized');
  } catch (emailError) {
    console.warn(
      'Email scheduler not available (node-cron may be missing):',
      emailError.message
    );
  }
